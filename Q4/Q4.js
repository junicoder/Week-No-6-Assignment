...
if (price >= 100) {
    ...
    console.log(`The actual price is $${price} you got 10% discount new price is $${new_p}`);
}
else {
    discount = 100 * 0.05;
    new_p = price - discount;
    console.log(`The actual price is $${price} you got 5% discount new price is $${new_p}`);
}
